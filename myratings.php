...
<div class="column left">
    ...
    <form class="ordering" action="myratings.php" method="post">
        ...
        <input type="submit" name="order_rating_desc" value="Rating (Highest)"/>
        <input type="submit" name="order_rating_asc" value="Rating (Lowest)"/>
    </form>
    <hr>
    <div class="list_rating">
        ...
        if (isset($_POST['rate'])) {
            if (isset($_POST['my_rating'])) {
                ...
                $my_rate = $_POST['my_rating'];
                insert_rating($conn, $_SESSION['username'], $movie_name, $my_rate);
            }
        }
        ...
        if (isset($_POST['order_rating_desc'])) {
            $ordering = " ORDER BY r.vote DESC";
        }
        if (isset($_POST['order_rating_asc'])) {
            $ordering = " ORDER BY r.vote ASC";
        }

        $result = get_my_ratings($conn, $_SESSION['username'], $ordering);
        echo "<table>";
        echo "<tr>";
        echo "<td><b>| My Vote </b></td>";
